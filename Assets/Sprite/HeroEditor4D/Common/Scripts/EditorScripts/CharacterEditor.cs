    ...
    public class CharacterEditor : MonoBehaviour
    {
        ...
        protected List<SpriteRenderer> ResolveParts(string target)
        {
            switch (target)
            {
                ...
                case "Back": return Character.Parts.Select(i => i.BackRenderer).Where(i => i != null).ToList();
                case "Wings": return Character.Parts.Select(i => i.WingsRenderer).Where(i => i != null).ToList();
